package com.diego.masteringroommigrations
...
class StudentDatabaseMigrationsTest {
    ...
    fun migrate1to2() {
        database = migrationTestHelper.createDatabase(TEST_DB, 1).apply {
            ...
            execSQL(
                """
                INSERT INTO Student VALUES (1, 'Diego',  'Medina') 
                """.trimIndent()
            )
        ...
        assertEquals("Diego", nameFromDatabase)
    }
    ...
    fun migrate2to3() {
        database = migrationTestHelper.createDatabase(TEST_DB, 2).apply {
            ...
            execSQL(
                """
                INSERT INTO Student VALUES (1, 'Diego',  'Medina', 10) 
                """.trimIndent()
            )
        ...
        assertEquals("Diego", resultCursor.getString(firstNameColumnIndex))
    ...
    fun migrate3to4() {
        database = migrationTestHelper.createDatabase(TEST_DB, 3).apply {
            ...
            execSQL(
                """
                INSERT INTO Student VALUES (1, 'Diego', 10.0) 
                """.trimIndent()
            )
